...
Extra packages do not prevent a command from running, although `rpx status` reports them as unexpected. The installed project package is optional, matching dependency-only synchronization.

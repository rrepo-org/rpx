...
For an unconstrained dependency, rpx records the selected version as a lower bound and the next major version as an upper bound. If `examplepkg` resolves to `1.4.2`, rpx writes:
